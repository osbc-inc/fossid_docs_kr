...
FossID 납품물에 대한 접근 정보는 delivery mail에 포함되어 있습니다.

`fossid-release_regular.x86_64.rpm` delivery portal에서 다운로드하세요 .
...
#### &#x20;<a href="#install-web-server" id="install-web-server"></a>
