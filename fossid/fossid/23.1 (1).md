...
* 대용량 데이터베이스가 포함된 <mark style="color:red;background-color:yellow;">**Workbench 22.2 또는 23.1 이전 버전에서 최신 버전으로 업데이트 하는 경우, 특정 데이터베이스 변경으로 인해 업데이트 시간이 매우 길어질 수 있습니다.**</mark>
